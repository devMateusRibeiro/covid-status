...
texto_titulo = Label(janela, text="Estatísticas do COVID-19", **fundo_branco, font=(None, 20))
...
quantidade_infectados = Label(janela, text="----", **fundo_branco, **fonte_padrao)
quantidade_infectados.grid(column=0, row=2, **padding10x)

quantidade_recuperados = Label(janela, text="----", **fundo_branco, **fonte_padrao)
quantidade_recuperados.grid(column=1, row=2, **padding10x)

quantidade_mortes = Label(janela, text="----", **fundo_branco, **fonte_padrao)
